...
import { CLAUDE_TLS_BROWSER_MAJOR_VERSION, tlsFetchClaude } from "../services/claudeTlsClient.ts";
...
const CLAUDE_USER_AGENT =
  ...
  `(KHTML, like Gecko) Chrome/${CLAUDE_TLS_BROWSER_MAJOR_VERSION}.0.0.0 Safari/537.36`;
...
function getBrowserHeaders(
  ...
  const headers: Record<string, string> = {
    ...
    Priority: "u=1, i",
    Referer: referer,
    "Sec-Ch-Ua": `"Chromium";v="${CLAUDE_TLS_BROWSER_MAJOR_VERSION}", "Not-A.Brand";v="24", "Google Chrome";v="${CLAUDE_TLS_BROWSER_MAJOR_VERSION}"`,
    "Sec-Ch-Ua-Mobile": "?0",
