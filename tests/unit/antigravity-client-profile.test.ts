...
test("normalizeAntigravityClientProfile defaults unsupported values to IDE", () => {
  ...
  assert.equal(normalizeAntigravityClientProfile("harness"), "ide");
  assert.equal(normalizeAntigravityClientProfile("sdk"), "ide");
...
test("getAntigravityClientProfile falls back to IDE for invalid persisted values", () => {
  assert.equal(
